...
SI1=10;
[aSI2,bSI2]=betaPERT(8.5,9.4,9.8);
[aSI3,bSI3]=betaPERT(8.7,9.5,10);
pdSI2=makedist('beta',aSI2,bSI2);
pdSI3=makedist('beta',aSI3,bSI3);

XY=[icdf(pdSI2,vv(:,1)) icdf(pdSI3,vv(:,2))];
XYY(:,1)=XY(:,1)*(9.8-8.5)+8.5;
XYY(:,2)=XY(:,2)*(10-8.7)+8.7;

for i=1:n
   V_SI1(i)=FVcontinua(SI1,0,10,1,0.01,1,"creciente");
   V_SI2(i)=FVcontinua(XYY(i,1),0,10,1,0.01,1,"creciente");
   V_SI3(i)=FVcontinua(XYY(i,2),0,10,1,0.01,1,"creciente");   
end
% Comprobación correlaciones
