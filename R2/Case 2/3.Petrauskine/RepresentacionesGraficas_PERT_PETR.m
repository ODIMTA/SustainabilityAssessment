...
[strE,strS,strM,str,MediaISE,DesvISE,VarISE,MinimoISE,MaximoISE,MediaISS,DesvISS,VarISS,MinimoISS,MaximoISS,MediaISM,DesvISM,VarISM,MinimoISM,MaximoISM,MediaIS,DesvIS,VarIS,MinimoIS,MaximoIS,ISEcomb,ISScomb,ISMcomb,IScomb]=CocheCombProbabilistaCorrelacionado_28_03_2025_PERT_PETR;
[strE,strS,strM,str,MediaISE,DesvISE,VarISE,MinimoISE,MaximoISE,MediaISS,DesvISS,VarISS,MinimoISS,MaximoISS,MediaISM,DesvISM,VarISM,MinimoISM,MaximoISM,MediaIS,DesvIS,VarIS,MinimoIS,MaximoIS,ISEelec,ISSelec,ISMelec,ISelec]=CocheElecProbabilistaCorrelacionado_28_03_2025_PERT_PETR;
[strE,strS,strM,str,MediaISE,DesvISE,VarISE,MinimoISE,MaximoISE,MediaISS,DesvISS,VarISS,MinimoISS,MaximoISS,MediaISM,DesvISM,VarISM,MinimoISM,MaximoISM,MediaIS,DesvIS,VarIS,MinimoIS,MaximoIS,ISEHEV,ISSHEV,ISMHEV,ISHEV]=CocheHEVProbabilistaCorrelacionado_28_03_2025_PERT_PETR;
[strE,strS,strM,str,MediaISE,DesvISE,VarISE,MinimoISE,MaximoISE,MediaISS,DesvISS,VarISS,MinimoISS,MaximoISS,MediaISM,DesvISM,VarISM,MinimoISM,MaximoISM,MediaIS,DesvIS,VarIS,MinimoIS,MaximoIS,ISEPHEV,ISSPHEV,ISMPHEV,ISPHEV]=CochePHEVProbabilistaCorrelacionado_28_03_2025_PERT_PETR;
...
hold on
    ...
    xlabel ('SI')
    ylabel ('Probability')
    legend("Conventional","EV","HEV","PHEV")
hold off
...
hold on
    ...
    histogram(ISFHEV_ordenado,A);
    histogram(ISFPHEV_ordenado,A);
    axis auto
    %axis ([0 1 0 100.5])
    grid
    xlabel ('SI')
...
%     histogram(ISEFHEV_ordenado,A);
%     histogram(ISEFPHEV_ordenado,A);
%     axis auto
%     %axis ([0 1 0 100.5])
%     grid
%     xlabel ('EI')
...
%     histogram(ISSFHEV_ordenado,A);
%     histogram(ISSFPHEV_ordenado,A);
%     axis auto
%     %axis ([0 1 0 100.5])
%     grid
%     xlabel ('SOI')
...
hold on
    ...
    histogram(ISMFHEV_ordenado,A);
    histogram(ISMFPHEV_ordenado,A);
    axis auto
    %axis ([0 1 0 100.5])
    grid
    xlabel ('ENI')
