function [strE,strS,strM,str,MediaISE,DesvISE,VarISE,MinimoISE,MaximoISE,MediaISS,DesvISS,VarISS,MinimoISS,MaximoISS,MediaISM,DesvISM,VarISM,MinimoISM,MaximoISM,MediaIS,DesvIS,VarIS,MinimoIS,MaximoIS,ISE,ISS,ISM,IS]=CocheElecProbabilistaCorrelacionado_28_03_2025_PERT_PETR

% Petrauskiene et al. (2021). Figura 5.
...
% Indicador medioambiental RecipeEndpoint

pdECO=makedist('uniform',2.43,3.65);
ECO=random(pdECO,1,n);

for i=1:n
   V_ECO(i)=FVcontinua(ECO(i),4.3,2.4,4.11,0.01,1,"decreciente");   
end
