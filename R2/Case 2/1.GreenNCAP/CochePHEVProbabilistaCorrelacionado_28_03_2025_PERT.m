function [strE,strS,strM,str,MediaISE,DesvISE,VarISE,MinimoISE,MaximoISE,MediaISS,DesvISS,VarISS,MinimoISS,MaximoISS,MediaISM,DesvISM,VarISM,MinimoISM,MaximoISM,MediaIS,DesvIS,VarIS,MinimoIS,MaximoIS,ISE,ISS,ISM,IS]=CochePHEVProbabilistaCorrelacionado_28_03_2025_PERT
...
VR=random(pdVR,1,n);
% Autonomía medida en km. PENDIENTE.
...
Rho4=[1 -0.4 0; -0.4 1 0.89; 0 0.89 1];
vv=copularnd('Gaussian',Rho4,n);
[aSI1,bSI1]=betaPERT(5.4,7.1,8.2);
[aSI2,bSI2]=betaPERT(4.9,5.5,6.0);
[aSI3,bSI3]=betaPERT(4.1,4.9,5.6);
...
XYY(:,1)=XY(:,1)*(8.2-5.4)+5.4;
XYY(:,2)=XY(:,2)*(6.0-4.9)+4.9;
XYY(:,3)=XY(:,3)*(5.6-4.1)+4.1;
