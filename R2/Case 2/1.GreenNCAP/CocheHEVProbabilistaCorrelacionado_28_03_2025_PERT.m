function [strE,strS,strM,str,MediaISE,DesvISE,VarISE,MinimoISE,MaximoISE,MediaISS,DesvISS,VarISS,MinimoISS,MaximoISS,MediaISM,DesvISM,VarISM,MinimoISM,MaximoISM,MediaIS,DesvIS,VarIS,MinimoIS,MaximoIS,ISE,ISS,ISM,IS]=CocheHEVProbabilistaCorrelacionado_28_03_2025_PERT
...
Rho4=[1 -0.3 -0.43; -0.3 1 0.92; -0.43 0.92 1];
vv=copularnd('Gaussian',Rho4,n);
[aSI1,bSI1]=betaPERT(3.8,6.7,9.3);
[aSI2,bSI2]=betaPERT(3.2,5.5,6.3);
[aSI3,bSI3]=betaPERT(1.5,4.0,5.2);
...
XYY(:,1)=XY(:,1)*(9.3-3.8)+3.8;
XYY(:,2)=XY(:,2)*(6.3-3.2)+3.2;
XYY(:,3)=XY(:,3)*(5.2-1.5)+1.5;
