...
- `Case 1/` and `Case 2/`: directories containing MATLAB functions for analyzing the two case studies and their variants as they are described in second revision of the paper.
