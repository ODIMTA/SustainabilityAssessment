...
[aSI1,bSI1]=betaPERT(4.4,6.7,7.5);
[aSI2,bSI2]=betaPERT(3.3,5.5,5.6);
[aSI3,bSI3]=betaPERT(1.7,4.0,4.3);
...
XYY(:,1)=XY(:,1)*(7.5-4.4)+4.4;
XYY(:,2)=XY(:,2)*(5.6-3.3)+3.3;
XYY(:,3)=XY(:,3)*(4.3-1.7)+1.7;
