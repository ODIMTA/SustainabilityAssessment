function [ISE,ISS,ISM,IS]=SostenibilidadBMW_18_03_2025

% DATOS BMW 220i ACTIVE TOURER
...
% Indicador de clean air SI1, medido en puntos de 0 a 10. Cuantos más
% puntos, mejor desempeño.
SI1=7.5;
V_SI1=FVcontinua(SI1,0,10,1,0.01,1,"creciente");

% Indicador de energy effect SI2. Misma forma de evaluar que SI1.
SI2=4.7;
V_SI2=FVcontinua(SI2,0,10,1,0.01,1,"creciente");

% Indicador de greenhouse gas SI3. Misma forma de evaluar que los
% anteriores.
SI3=3.1;
V_SI3=FVcontinua(SI3,0,10,1,0.01,1,"creciente");
...
ISM=PCriterioMedioambiental*(PSI1*V_SI1+PSI2*V_SI2+PSI3*V_SI3);
